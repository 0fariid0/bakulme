...
case $choice in
  1)
    ...
    if [[ ! -f "/root/backhaul" ]]; then
      download_file "https://github.com/0fariid0/bakulme/blob/main/backhaul" "/root/backhaul"
    else
  ...
  2)
    echo "Iran selected."
    download_file "https://github.com/0fariid0/bakulme/blob/main/ir.zip" "ir.zip"
    extract_zip "ir.zip"
  ...
  3)
    ...
    download_file "https://github.com/0fariid0/bakulme/blob/main/kh.zip" "kh.zip"
    extract_zip "kh.zip"
